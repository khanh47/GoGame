...
public:
	enum class VolumeType { SoundEffects, Music };
...
public:
	enum class MuteType { SoundEffects, Music };
...
public:
	enum class ThemeTarget { Board, Stone };
...
public:
	enum class ColorTarget { Board, Stone };
