...
public:
    GameCommand(GameController* gameModel)
...
public:
    UndoCommand(GameController* gameController)
        : GameCommand(gameController) {}
...
public:
    RedoCommand(GameController* gameController)
        : GameCommand(gameController) {}
...
public:
    ResetCommand(GameController* gameController)
        : GameCommand(gameController) {}
...
public:
    PassCommand(GameController* gameController)
        : GameCommand(gameController) {}
