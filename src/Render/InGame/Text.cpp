...
Text::Text(Rectangle area) : _area(area) {}

void Text::setDependencies(const Rectangle &area) { _area = area; }
...
void Text::render() const {
	...
	DrawTextEx(font, _text.c_str(), {_area.x + (_area.width - textLen) / 2.0f, _area.y + 10}, 28, 3, BLACK);
}
