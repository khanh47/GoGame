...
void EndGameBox::close() { _open = false; }
...
void EndGameBox::render() const {
	...
	DrawTextEx(font, title, {xCenter - titleSizeVec.x / 2.0f, box.y + 40}, titleSize, spacing, BLACK);
	...
	DrawTextEx(font, p1str.c_str(), {xCenter - p1Size.x / 2.0f, box.y + 180}, textSize, spacing, BLACK);

	DrawTextEx(font, p2str.c_str(), {xCenter - p2Size.x / 2.0f, box.y + 240}, textSize, spacing, BLACK);
	...
	DrawTextEx(font, winner.c_str(), {xCenter - winSize.x / 2.0f, box.y + 330}, textSize + 10.f, spacing, BLACK);
}
