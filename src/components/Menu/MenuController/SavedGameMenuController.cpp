...
SavedGameMenuController::SavedGameMenuController(InGameScene* inGameScene, GameModel* gameModel)
...
void SavedGameMenuController::createSavedGameMenu() {
    ...
    btnDelete->setCommand(createDeleteSelectedCommand(_gameModel));
    ...
    _menuSystem->addItem(btnCreate);
		...
		if (_gameModel->isGameDataSelected()) {
    		...
    		btnSave->setCommand(createSaveToSelectedCommand(_gameModel));
