...
bool SceneManager::isEmpty() const { return _sceneStack.empty(); }

// Menu management
void SceneManager::showMenu() { _menuActive = true; }

void SceneManager::hideMenu() { _menuActive = false; }

bool SceneManager::isMenuActive() const { return _menuActive; }
...
GameStateModel *SceneManager::getGameStateModel() const { return _gameStateModel; }
...
std::unique_ptr<Scene> SceneManager::createScene(const std::string &name) { return nullptr; }
