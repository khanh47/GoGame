...
void MainMenuScene::init(void) { std::cout << "MainMenuScene initialized." << std::endl; }
...
void MainMenuScene::cleanup(void) { std::cout << "MainMenuScene cleaned up." << std::endl; }

bool MainMenuScene::isActive(void) const { return _isActive; }

std::string MainMenuScene::getName(void) const { return "MainMenuScene"; }

std::string MainMenuScene::getGameStateName(void) const { return "MAIN_MENU"; }
...
bool MainMenuScene::shouldTransition(void) const { return false; }
