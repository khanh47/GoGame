...
void SettingsState::onEnter(GameStateModel *context) { std::cout << "Entering Settings State" << std::endl; }

void SettingsState::onExit(GameStateModel *context) { std::cout << "Exiting Settings State" << std::endl; }

void SettingsState::update(GameStateModel *context, float deltaTime) {}

std::unique_ptr<GameState> SettingsState::clone() const { return std::make_unique<SettingsState>(); }

std::unique_ptr<Scene> SettingsState::createScene() const { return std::make_unique<SettingsScene>(); }

std::shared_ptr<MenuComponent> SettingsState::createNavigationMenu(GameStateModel *gameStateModel,
...
SettingsState::createNavigationMenuButtonItemViews(std::shared_ptr<MenuComponent> menu) const {
