...
std::unique_ptr<GameState> GameDataState::clone() const { return std::make_unique<GameDataState>(); }

std::unique_ptr<Scene> GameDataState::createScene() const { return std::make_unique<GameDataScene>(); }

std::shared_ptr<MenuComponent> GameDataState::createNavigationMenu(GameStateModel *gameStateModel,
...
GameDataState::createNavigationMenuButtonItemViews(std::shared_ptr<MenuComponent> menu) const {
